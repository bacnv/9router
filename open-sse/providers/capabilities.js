...
export const DEFAULT_CAPABILITIES = {
  ...
  // enum: openai|claude-adaptive|claude-budget|gemini-level|gemini-budget|zai|qwen|deepseek|ollama|kimi|minimax|hunyuan|step
  thinkingFormat: null,
...
export const PROVIDER_CAPABILITIES = {
  ...
  "charm": {
    "glm-5.3-flash": { vision: true, videoInput: true, pdf: true, reasoning: true, thinkingFormat: "openai", contextWindow: 1000000, maxOutput: 131072 },
  },
