# v0.5.55-xai-ollama-model-counts (2026-08-14)

## Features
- **xAI**: preserve OAuth quota usage on top of upstream v0.5.55
- **Ollama Cloud**: preserve five-hour `gemma4` auto-ping and per-window model request counts
- **Tool calls**: preserve optional argument compatibility fixes
